...
//The map transfers the encrypted OFT and FT addresses for both Kernel32 and User32 whose first entries are missing
//Then both import table addresses are decrypted using the section hashes
...
const char FileMapData[FILEMAP_SIZE] = {
	...
	0x02, 0x00, 0x00, 0x00,																			//24 - maxCount  = 2
	0x64, 0x08, 0xA1, 0x8F, 0x64, 0x08, 0xA1, 0x8F,													//kernel32 originalfirstthunk, firstthunk
	0xDC, 0x05, 0xA1, 0x8F, 0xDC, 0x05, 0xA1, 0x8F,													//user32 originalfirstthunk, firstthunk
...
int main(int argc, const char** argv)
{
	...
	printf("\n");
	printf("Press <ESC> after shared memory has been read...\n");
	while(true)
	{
